...
const TeacherAssignmentDetails = () => {
    ...
    const getSubmissionStatus = (submission) => {
        ...
        if (submission.remarks && submission.remarks.length > 0) {
            const latestRemark =
                submission.remarks[submission.remarks.length - 1];
            if (latestRemark.resubmissionRequired) {
    ...
    const handleRemarkSubmit = async (e) => {
        ...
        try {
            ...
            toast.error(
                error.response?.data?.message || "Failed to submit remark"
            );
        }
    };
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-8 px-4 sm:px-6 lg:px-8 mt-15">
                                                ...
                                                {remarkData.resubmissionRequired && (
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                                            value={
                                                                remarkData.resubmissionDeadline
                                                            }
                                                            onChange={(e) =>
                                                                setRemarkData({
                                                                    ...remarkData,
