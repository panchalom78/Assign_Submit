...
import { FaBars, FaTimes, FaTachometerAlt, FaTasks, FaUser, FaComments, FaStar, FaClipboardList, FaCalendar, FaBell } from 'react-icons/fa';
...
const Menu = () => {
  ...
  return (
    <div className='fixed top-0 left-0 z-40'>
      ...
      {/* Menu */}
      <div
        className={`fixed inset-y-0 left-0 h-screen w-64 bg-gray-900 text-white p-6 transform transition-transform duration-300 ease-in-out ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'
